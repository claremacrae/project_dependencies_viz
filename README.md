...
This means that if you use CMake, and if you spend time post-processing the CMake graphviz output to add URL attributes, you could probably answer my "What depends on a particular library?" question above, for your projects, really quite quickly.
